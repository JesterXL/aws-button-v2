...
const NAME_PREFIX         = 'iotbutton_G030MD0283529BRS_iot-button-sms-nodejs';
const QUALIFIER           = 'defaultalias';
const DEFAULT_ENVIRONMENT = 'dev';
const FUNCTION_NAME       = NAME_PREFIX;
...
// async function deleteThenDestroy()
// {
//     try
//     {
//         await deleteFunction(lambda);
//         await createFunction(lambda, fs);
//     }
//     catch(err)
//     {
//         log("err:", err);
